...
//
//
//                        //before 11.05. was PutPDF putPDF = new PutPDF(selectPDF.getText().toString(), uri.toString());
//                        PutPDF putPDF = new PutPDF(selectPDF.getText().toString(), uri.toString(), toString(), toString(), toString());
//
