...
public class JobPage extends AppCompatActivity {
    ...
    private void uploadPDFFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("uploadJob" + System.currentTimeMillis() + ".pdf");
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(JobPage.this, "PDF File is uploaded", Toast.LENGTH_LONG).show();
